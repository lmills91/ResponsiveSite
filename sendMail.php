...
<div class="container" id="mainContent"> 
	...
	<div><!--page header-->
		...
		<div class="panel-banner col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
     		...
     		<div class="panel-body text-success text-center" style="background:white;">
     			<?php
					...
					VALUES ('". $_POST["mailMessage"]. "', '". $_POST["userName"]. "', '". $_POST["emailAddress"]. "')";
					
					if ($conn->query($sql) === TRUE) {
					    echo "<h3>Thank you ". $_POST["userName"] . ", your query was submitted successfully.<br> We will get back to you ASAP</h3>";
					} else {
