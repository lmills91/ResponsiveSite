	...
	<div><!--page header-->
		...
		<div class="panel-banner col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
     		...
     		<div class="panel-body text-center" style="background:white;">
					...
					$username = "u967358224_lm12";
					$password = "9653YQ58";
					$dbname = "u967358224_mydat";
					...
					$sql = "INSERT INTO questionnaire (device, question1, question2, question3, question4, question5, question6, question7, question8, question9, question10) 
					VALUES ('". $_POST["device"]. "', '". $_POST["question1"]. "', '". $_POST["question2"]. "', '". $_POST["question3"]. "', '". $_POST["question4"]. "', '". $_POST["question5"]. "', '". $_POST["question6"]. "', '". $_POST["question7"]. "', '". $_POST["question8"]. "', '". $_POST["question9"]. "', '". $_POST["question10"]. "')";
					
					if ($conn->query($sql) === TRUE) {
					    echo "<h3>Thank you! Your survey was submitted successfully.</h3>";
					} else {
					    echo "There was an error: " . $sql . "<br>" . $conn->error;
					}
